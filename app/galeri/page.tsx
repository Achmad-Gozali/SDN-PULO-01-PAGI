...
import { galleryItems, categories } from "@/lib/gallery-data";
...
export default function GalleryPage() {
  ...
  // FIX: tambah state searchQuery yang sebelumnya tidak ada
  const [searchQuery, setSearchQuery] = useState("");

  // FIX: filter sekarang mempertimbangkan kategori DAN search query sekaligus
    ...
    <main className="min-h-screen bg-slate-50">
      ...
      <section className="py-12 px-6 sticky top-[72px] z-30 bg-slate-50/80 backdrop-blur-md border-b border-slate-200">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          {/* FIX: search input sekarang punya value dan onChange yang terhubung ke state */}
