...
export default function MadingListPage() {
  const [searchQuery, setSearchQuery] = useState("");

  const filteredPosts = madingPosts.filter((post) =>
      ...
      <section className="pt-32 pb-16 bg-blue-900 text-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 text-center">
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-blue-800 border border-blue-700 text-blue-200 text-xs font-bold uppercase tracking-widest mb-6"
          >
          ...
          >
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-4 rounded-2xl bg-white text-slate-900 shadow-xl focus:ring-4 focus:ring-blue-500/20 outline-none transition-all"
            />
          </motion.div>
        </div>
      </section>
